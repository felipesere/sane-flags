...
type SyncTogglingClosure<TFlagName> = <TResult>(
  name: TFlagName,
  closure: () => TResult
) => TResult
type AsyncTogglingClosure<TFlagName> = <TResult>(
  name: TFlagName,
  closure: () => Promise<TResult>
) => Promise<TResult>

export interface FeatureFlags<
  TConfig extends Config,
  TFlagName extends keyof TConfig['flags'] & string
> {
...
export declare function wrap<
  TConfig extends Config,
  TFlagName extends keyof TConfig['flags'] & string
>(config: TConfig): FeatureFlags<TConfig, TFlagName>
